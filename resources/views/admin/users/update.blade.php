...
@endif
      ...
      @csrf
        ...
        <div class="card card-default">
          ...
          <h2 class="card-title"><b>User Update</b></h2>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
              <input type='hidden' name='id' value='{{old("id")??$user->id}}' required class='form-control'>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Email</label>
                  <input type='email' required name='email' value='{{old("email")??$user->email}}' required class='form-control'>
                </div>
                <!-- /.form-group -->
